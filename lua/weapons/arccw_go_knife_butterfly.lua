...
SWEP.ViewModel = "models/weapons/arccw_go/v_knife_butterfly.mdl"
SWEP.WorldModel = "models/weapons/arccw_go/w_csgo_butterfly.mdl"
...
if CLIENT then -- i can't be bothered to fuck with the model
    ...
    function SWEP:Deploy()
        surface.PlaySound("arccw_go/bknife/bknife_draw02.wav")
    end
