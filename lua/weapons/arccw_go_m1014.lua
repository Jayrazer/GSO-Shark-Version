...
SWEP.Trivia_Desc = "A weapon that's nearly synonmous with the concept of semi-auto shotguns as a whole, the M1014 uses the unique ARGO dual gas-pistol system, developed jointly with the U.S. military."
