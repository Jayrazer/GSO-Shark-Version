...
SWEP.ViewModel = "models/weapons/arccw_go/v_csgo_bowie.mdl"
SWEP.WorldModel = "models/weapons/arccw_go/w_csgo_bowie.mdl"
...
if CLIENT then -- i can't be bothered to fuck with the model
    ...
    function SWEP:Deploy()
        surface.PlaySound("arccw_go/knife_bowie/knife_bowie_draw.wav")
    end
