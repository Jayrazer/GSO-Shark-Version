...
SWEP.ViewModel = "models/weapons/arccw_go/v_csgo_default_t.mdl"
SWEP.WorldModel = "models/weapons/arccw_go/w_csgo_default_t.mdl"
...
function SWEP:Deploy()
    surface.PlaySound("arccw_go/knife/knife_deploy.wav")
end
